...
<body>
    <div class="buttons-left">
        ...
        </div> <a id="rules" class="btn btn-block btn-info" href="#design-rules" onclick="ifrmdesignrules();">Design Rules</a> <a id="arguments" class="btn btn-block btn-info" href="#design-arguments" onclick="ifrmdesignarguments();">Design Arguments</a> <a id="mockup" class="btn btn-block btn-info" href="#" onclick="chooseMockup();">Design Mockup</a> </div>
